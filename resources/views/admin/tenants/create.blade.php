        ...
        <div class="px-4 py-6 sm:p-8">
            <form action="{{ route('admin.tenants.store') }}" method="POST">
                ...
                <div class="mt-8 flex items-center justify-end gap-x-6">
                    ...
                    <button type="submit" class="rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">Create Tenant</button>
                </div>
            </form>
        </div>
    </div>
