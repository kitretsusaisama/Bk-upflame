        ...
        <div class="px-4 py-6 sm:p-8">
            <form action="{{ route('tenant.users.update', $user) }}" method="POST">
                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-4">
                        <label for="password" class="block text-sm font-medium leading-6 text-gray-900">Password (Leave blank to keep current)</label>
                        <div class="mt-2">
                ...
                <div class="mt-8 flex items-center justify-end gap-x-6">
                    ...
                    <button type="submit" class="rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">Update User</button>
                </div>
            </form>
        </div>
    </div>
